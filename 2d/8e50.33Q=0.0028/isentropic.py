...
# %%
folder_dir = "/scratch/zb2113/DedalusData/8e50.33Q=0.0028/snapshots"
save_dir= "/home/zb2113/Dedalus-Postanalysis/2D/8e50.33Q=0.0028"
...
plt.contour(M_grid, z_grid, logiClcond, colors='k')
plt.contourf(M_grid, z_grid, logiClcond, cmap='RdBu_r')
