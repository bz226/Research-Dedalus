...
#Plotting (Incomplete)
logiPav=np.log(iPav)
plt.contourf(M_grid, z_grid, logiPav,cmap='RdBu_r', levels=100)
...
#Plotting (Incomplete)
plt.contourf(M_grid, z_grid, Psi_Mav,cmap='RdBu_r', levels=100)
...
plt.xlabel('M/(M_0-M_H)')
plt.ylabel('z')
plt.savefig(f'isentropic/Psi_Mass.png', dpi=200, bbox_inches='tight')
plt.close()
