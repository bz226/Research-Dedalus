...
write,dt=solver.load_state('restart/restart_s10.h5')

# %%
# Analysis
snapshots = solver.evaluator.add_file_handler('snapshots', sim_dt=0.5, max_writes=1,mode='append')
...
restart = solver.evaluator.add_file_handler('restart', sim_dt=50, max_writes=1,mode='append')
